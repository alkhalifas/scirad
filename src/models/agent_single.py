...
class IntelligentAgent:
    ...
    def chain_of_thought_prompt(self):
        return (
            ...
            "Step 4: Compose a coherent summary based on the above analysis.\n\n"
    ...
    def tree_of_thought_prompt(self):
        return (
            ...
            "The final summary should be approximately {summary_word_count} words."
        )
    ...
    def generate_summary_prompt(self):
        ...
        prompt_template = (
            ...
            f"The summary is mean to be a single paragraph that summarizes the findings of the article's findings"
            f"Ensure that the summary highlights the key findings, methodologies, and implications related to {', '.join(self.keywords)}. "
            f"The summary should be approximately {self.summary_word_count} words, suitable for a weekly update, emphasizing key findings while omitting specific details."
        )
    ...
    def process(self):
        ...
        judge_evaluation = self.judge_summary(summary)
